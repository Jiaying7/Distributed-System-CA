public class WaterPollutionMonitorRequest<WaterQualityParameter, Empty, observersMap, observersMap> extends WaterPollutionMonitorRequestGrpc.WaterPollutionMonitorRequestImplBase{
    ...
    public void reportWaterQuality(WaterQualityParameter request, StreamObserver<Empty> responseObserver) {
        String region = ((Object) request).getRegion().getName();
