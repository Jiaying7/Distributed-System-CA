...
public class AirPollutionTrackerServer {
    ...
    static class AirPollutionTrackerImpl<Empty> extends AirPollutionTrackerGrpc.AirPollutionTrackerImplBase {
        @Override
        public void getAirQuality(AirQualityRequest request, StreamObserver<airQuality> responseObserver) {
